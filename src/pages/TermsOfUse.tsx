      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-white/20">
          <div className="text-steel-blue-200 space-y-6 leading-relaxed">
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">1. Eligibility</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">2. Game Overview</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">3. Payments & USDC</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">4. Redemption Process</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">5. Restaurant Participation</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">6. Prohibited Conduct</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">7. Account & Security</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">8. KYC & Compliance</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">9. Intellectual Property</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">10. Disclaimers & Limitation of Liability</h2>
              <ul className="ml-4 space-y-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">11. Termination</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">12. Dispute Resolution</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">13. Governing Law</h2>
              <p>These Terms are governed by the laws of the State of Georgia, without regard to conflict of laws principles.</p>
            </div>

            <div>
              <h2 className="text-xl font-bold text-steel-blue mb-4">14. Modifications</h2>
