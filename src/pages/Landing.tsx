        ...
        <header className="relative z-10 w-full">
          <div className="flex justify-between items-start p-4 sm:p-6 lg:p-8">
            ...
            <div>
              ...
              <Link
                to="/restaurant-games"
                className="group relative w-1000 food-card text-gray-900 px-8 py-6 sm:px-12 sm:py-8 font-black font-display hover:text-primary-600 transition-all duration-300 transform hover:scale-110 food-glow overflow-hidden shadow-xl hover:shadow-2xl animate-pulse"
              >
                {/* Animated background */}
                <div className="absolute inset-0 bg-gradient-to-r from-primary-400/30 via-success-500/30 to-primary-400/30 animate-pulse"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 animate-shimmer"></div>
