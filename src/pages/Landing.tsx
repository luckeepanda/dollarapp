      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-royal-blue-500 via-steel-blue-500 to-royal-blue-600">
        ...
        <div className="absolute top-8 left-8 right-8 flex justify-between items-center z-10">
          ...
          <div className="flex flex-col space-y-3">
            ...
            >
              {/* Falcon Logo */}
              <div className="w-20 h-20 mb-1 rounded-xl">
                <img 
                  src="/falcon-logo.png" 
                  alt="Falcon Logo" 
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-lg font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent animate-pulse">
                  Play Demo
                </span>
              </div>
            </Link>
