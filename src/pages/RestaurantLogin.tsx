    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-steel-blue-900 via-royal-blue-900 to-steel-blue-800">
      ...
      <div className="relative max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <Link to="https://discord.com/channels/@me/720832865016741889/1391961779093114963" className="text-steel-blue-500 font-semibold hover:text-steel-blue-600 transition-colors">
